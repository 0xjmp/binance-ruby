...
RSpec.describe Binance::Api::DataStream do
  let(:params) { {} }
  ...
  describe '#start!' do
    ...
    subject { Binance::Api::DataStream.start! }
    ...
    context 'when listen_key exists' do
      ...
      context 'and api succeeds' do
        ...
        it 'responds with listen_key' do
          expect(subject[:listenKey]).to eq(listen_key)
        end
  ...
  describe '#stop!' do
    ...
    subject { Binance::Api::DataStream.stop!(listen_key: listen_key) }
